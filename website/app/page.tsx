      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,${encodeURIComponent('<svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd"><g fill="#059669" fillOpacity="0.1"><circle cx="30" cy="30" r="4"/></g></g></svg>')}")`,
            }}
          />
        </div>
